...
*  Revision 1.1a                                           *
*                                                          *
*  wininet.dll needs to be in the windows/system directory.*
*                                                          *
		...
		PROCEDURE LoadAPIFuncs		
		  * Variables need for defines
		   ...
		   * Declare DLL functions used by Program
		   	DECLARE Integer InternetAutodial IN WinInet Integer nAccessType, Integer nHandle
		   	...
		   	DECLARE Integer InternetGoOnline IN WinInet	String @lpcURL, Integer nHandle, Integer nFlags
